...
describe("usage codec", () => {
  it("round-trips a cumulative usage ledger", () => {
    const ledger = {
      observe: { input: 100, output: 50, cacheRead: 10, cacheWrite: 4, cost: 0.02, turns: 3, runs: 1, elapsedMs: 0 },
      build: { input: 200, output: 80, cacheRead: 20, cacheWrite: 8, cost: 0.05, turns: 5, runs: 1, elapsedMs: 0 },
      select: { input: 0, output: 0, cacheRead: 0, cacheWrite: 0, cost: 0, turns: 0, runs: 0, elapsedMs: 0 },
    };
  ...
  it("normalizes a legacy persisted ledger using the `passes` field name to `runs`", () => {
    ...
    expect(decoded).toEqual({
      observe: { input: 100, output: 50, cacheRead: 10, cacheWrite: 0, cost: 0.02, turns: 3, runs: 1, elapsedMs: 0 },
      build: { input: 0, output: 0, cacheRead: 0, cacheWrite: 0, cost: 0, turns: 0, runs: 0, elapsedMs: 0 },
      select: { input: 0, output: 0, cacheRead: 0, cacheWrite: 0, cost: 0, turns: 0, runs: 0, elapsedMs: 0 },
    });
  });
